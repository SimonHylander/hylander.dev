...
const LeftNavigation = () => {
  return (
    <nav className={`mt-4 text-foreground border border-secondary grid grid-cols-[auto_1fr] bg-white mx-auto shadow-[5px_5px_0_rgb(38_26_42),10px_10px_0_rgb(218_178_255)]`}>
      ...
      <ul className="flex gap-[2px] list-none border border-left-2 border-secondary bg-secondary">
...
function NavigationItem({ href, title, children }: { href: string; title: string; children: React.ReactNode }) {
  return (
    <li className="flex gap-2 bg-background items-center hover:bg-secondary hover:text-primary">
