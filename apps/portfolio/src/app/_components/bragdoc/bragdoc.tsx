...
function BragdocItem({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "border-none w-full flex flex-col",
          isEven ? "justify-start" : "justify-end"
        )}
      >
        <div
          className={cn(
            `group flex w-full justify-start items-start py-24 px-16 hover:no-underline`,
            isEven
              ? "bg-purple-900 border-1 border-purple-200"
          ...
          >
            <div
              className={cn(
                ...
                isEven ? "text-red-100" : "text-purple-900"
              )}
            >
              ...
              <div className="flex flex-col gap-4 text-sm transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down text-inherit">
                <h5 className="flex gap-2 items-center text-lg text-inherit">
